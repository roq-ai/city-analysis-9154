...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Crime Organisations',
      path: '/crime-organisations',
    ...
    { name: 'People', path: '/people', entity: 'person', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
