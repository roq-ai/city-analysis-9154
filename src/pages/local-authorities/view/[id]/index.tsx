...
import { getLocalAuthorityById } from 'apiSdk/local-authorities';
import { LocalAuthorityInterface } from 'interfaces/local-authority';

function LocalAuthorityViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('local_authority', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/local-authorities/edit/${id}`} passHref legacyBehavior>
                    <Button
