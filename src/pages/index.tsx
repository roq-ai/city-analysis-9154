...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`City Analysis`}</title>

        <meta
          name="description"
          content="City Analysis: Empowering you with comprehensive city insights, from danger levels to local history. Choose your topics, get your personalized report, and unlock your city's secrets with a subscription."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1485368647436-ff0fb9990605?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaXR5JTIwaW5mb3JtYXRpb258ZW58MHx8fHwxNjk1MzI0NzAzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@andresgarcia?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Andres Garcia`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`City Analysis: Empowering you with comprehensive city insights, from danger levels to local history. Choose your topics, get your personalized report, and unlock your city's secrets with a subscription.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Subscriber" type="subscriber" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
